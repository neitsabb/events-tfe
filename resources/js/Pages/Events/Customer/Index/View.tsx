...
const festivals = [
  {
    image:
      'https://res.cloudinary.com/shotgun/image/upload/ar_2:3,c_limit,f_auto,fl_lossy,q_auto,w_480/v1702033187/production/artworks/RES_2024_Billetterie_Shotgun_720x1080_ldntxi',
  ...
  {
    image:
      'https://res.cloudinary.com/shotgun/image/upload/ar_2:3,c_limit,f_auto,fl_lossy,q_auto,w_480/v1717594842/production/artworks/RDRE24-BILLETTERIE-artistes_hisrt6',
    title: 'Rock En Seine 2024',
    location: 'Saint-Cloud, France',
    start_date: 'mer 21',
    end_date: 'dim 25 août',
  ...
  {
    image:
      'https://res.cloudinary.com/shotgun/image/upload/ar_2:3,c_limit,f_auto,fl_lossy,q_auto,w_480/v1706883275/production/artworks/shotgun-2024-2000x3000_-_rubrique_festival_hog5dp',
    title: 'Rock En Seine 2024',
    location: 'Saint-Cloud, France',
    start_date: 'mer 21',
    end_date: 'dim 25 août',
  ...
  {
    image:
      'https://res.cloudinary.com/shotgun/image/upload/ar_2:3,c_limit,f_auto,fl_lossy,q_auto,w_480/v1723046821/production/artworks/maMARTEN_LOU_BANNER_2000x3000_1_e81ptj',
    title: 'Rock En Seine 2024',
    location: 'Saint-Cloud, France',
    start_date: 'mer 21',
    end_date: 'dim 25 août',
          ...
          <div className="pb-12">
            <div className="flex grid-cols-2 gap-x-4 gap-y-12 mt-6">
              {randomCities.map((city) => (
                <div
                  key={city.value}
                  className="bg-accent hover:bg-accent/50 rounded-lg p-4 w-full aspect-video flex flex-col justify-center items-center text-white/90"
                >
                  <Building />
                  <h3 className="text-lg font-semibold">{city.label}</h3>
                  <p className="text-sm text-white/60">15 événements</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <div className="container !max-w-7xl">
          <header className="py-16 flex items-end gap-16">
            ...
            <p className="max-w-[400px]">
              Envie de scénographies immersives, de corps bronzés, d’outfits
              incroyables, d’artistes talentueux et de musique hors du commun ?
              Choisis ton ambiance pour la saison des Festivals !
            </p>
          </header>
          <div className="grid grid-cols-4 gap-6">
            {festivals.map((festival) => (
              <div key={festival.title}>
                ...
                <h2 className="text-md font-medium ">{festival.title}</h2>
  ...
  return (
    <>
      ...
      <div className="flex justify-center my-20">
        <Button variant={'customer'}>Voir les événements à bruxelles</Button>
      </div>
    </>
  );
};
